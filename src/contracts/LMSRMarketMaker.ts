...
export interface LMSRMarketMakerInterface extends utils.Interface {
  functions: {
...
export interface LMSRMarketMaker extends BaseContract {
  ...
  functions: {
    ...
    calcMarginalPrice(
      outcomeTokenIndex: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
